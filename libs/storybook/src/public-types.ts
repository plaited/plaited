 ...
 */
export type Meta<TArgs = Args> = ComponentAnnotations<PlaitedRender, TArgs>;
 ...
 */
export type StoryFn<TArgs = Args> = AnnotatedStoryFn<PlaitedRender, TArgs>;
 ...
 * @see [Named Story exports](https://storybook.js.org/docs/formats/component-story-format/#named-story-exports)
 */
export type StoryObj<TArgs = Args> = StoryAnnotations<PlaitedRender, TArgs>;
