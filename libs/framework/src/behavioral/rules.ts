...
import type { Sync, RulesFunction, Loop, Thread } from './types.js'
 ...
 *
 * @param {RulesFunction | (() => boolean)} firstArg - The first argument can be a behavioral rules to be executed in the loop
 ...
 * @param {...RulesFunction[]} restArgs - An arbitrary number of additional behavioral rules to be executed in the loop.
 * @returns {RulesFunction} A behavioral thread that represents the looping behavior.
 */
