...
import { PublisherWithInitialValue, PublisherWithoutInitialValue } from "./use-publisher.js";
...
export const useConnect = ({
  ...
  function connect (target: PublisherWithInitialValue | PublisherWithoutInitialValue, type: string): void
  function connect (target: typeof WORKER | typeof SOCKET | PublisherWithInitialValue | PublisherWithoutInitialValue, type?: string){
    if(target === WORKER) {
    ...
    disconnectSet.add(target.sub(type, trigger))
  }
  return connect
}