/**
 * [Rutt](https://github.com/denosaurs/rutt) is a tiny http router designed for use with deno and deno deploy.
...
/**
 * A handler for HTTP requests. Consumes a request and {@link ConnInfo}
...
export interface Routes {
  [key: string]: Routes | MatchHandler
}
...
export type InternalRoute = {
  ...
  methods: Record<string, MatchHandler>
}
