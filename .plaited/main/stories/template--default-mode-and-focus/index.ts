...
import { defaultModeAndFocus } from '../../../../src/main/stories/template.stories.tsx'
if(canUseDOM()) {
  ...
  fixture?.trigger({
    type: 'play',
    detail: {
      route: "/main/stories/template--default-mode-and-focus",
      entry: "/Users/eirby/Workspace/lab/plaited/src/main/stories/template.stories.tsx",
      exportName: "defaultModeAndFocus",
      story: defaultModeAndFocus
    }
  });
}
