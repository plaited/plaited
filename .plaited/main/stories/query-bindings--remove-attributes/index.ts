...
import { removeAttributes } from '../../../../src/main/stories/query-bindings.stories.tsx'
if(canUseDOM()) {
  ...
  fixture?.trigger({
    type: 'play',
    detail: {
      route: "/main/stories/query-bindings--remove-attributes",
      entry: "/Users/eirby/Workspace/lab/plaited/src/main/stories/query-bindings.stories.tsx",
      exportName: "removeAttributes",
      story: removeAttributes
    }
  });
}
