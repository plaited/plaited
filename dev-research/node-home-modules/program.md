...
Research the default module bundle for node-home persistence and promotion.
...
to make node-home persistence a well-scoped module family that composes with
...
- Web/UI protocol lives in [src/ui/](../../src/ui) and [src/modules/server-module/](../../src/modules/server-module)
...
- `node-home-modules` owns persistence policy and promotion semantics
- `edit-modules` owns concrete write and edit strategy
- `memory-modules` owns durable recall and summarized memory policy
...
- persistence module behavior
  - when and how durable state changes happen
- promotion module behavior
...
The first shipped node-home module bundle should support:
...
- candidate persistence and promotion module bundles
