...
This lane should determine how MCP capabilities become default factory-owned
...
What is still open is the default-factory question:
...
The first shipped MCP factory should support:
...
2. projecting remote tools, prompts, and resources into a compact local
   capability surface
3. letting the model or a higher-level factory choose a remote MCP capability
...
- their use belongs in factory-owned policy
...
Candidate factories should make session handling reviewable:
...
The factory layer should not treat all MCP capability kinds as interchangeable.
...
- what is the smallest default MCP factory bundle that is genuinely useful?
- should manifest projection and live session execution be one factory or
  separate ones?
