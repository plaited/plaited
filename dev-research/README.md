# dev-research tombstone

This directory no longer contains active `program.md` instruction lanes.

Active architecture/research planning now happens through maintainer prompts, PR reviews, and
explicit handoff files for the current slice of work.
