...
Research the default memory module bundle for the Plaited agent.

This lane should define a `MemoryManager`-style module stack built on the
...
This is research work for a focused default module family, not a reason to
...
The first shipped memory module should support this end-to-end flow:
...
4. durable project state such as:
   ...
   - current module bundle assumptions
...
The module should use signals for active memory state such as:
...
This keeps memory state explicit and observable inside the current module
contract.
...
The memory module should support relevance-based retrieval of reflected
...
The live module and signal objects should remain type-first.
...
- one or more candidate memory module bundles
