...
Research the default observability-oriented factory bundle for the Plaited
agent.
...
- `observability-factories` owns retained traces and artifact policy
- `projection-factories` owns concise live summaries
- `memory-factories` owns longer-horizon recall and consolidation
...
The first shipped observability factory bundle should support:
...
- candidate observability factory bundles
