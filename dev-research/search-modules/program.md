...
Research the first default search-oriented module bundle for the Plaited
agent.
...
- grounds downstream module, module, and tool decisions in retrieved evidence

The first shipped search module should treat search as a policy surface, not
...
skill-module, module-discovery-module, memory-module, or ad hoc prompts.
...
- `skill-modules` owns skill discovery and activation
- `module-discovery-modules` owns module qualification and load policy
...
The best default search behavior will come from a dedicated search module that
...
- the module should expose concise search results, not entire raw logs
- search should improve downstream module and module selection rather than end
  at citation alone

## Product Target

The first shipped search module bundle should support:

1. deciding whether the current task needs search
2. classifying the search need, for example:
   - internal repo search
   - skill search
   - module or module discovery
...
6. feeding retrieved evidence into later module, module, and tool decisions
...
The module should provide one coherent search orchestration layer.
...
tool surfaces under the search module.

The search module should decide:
...
- correct module and module selection
...
- how should search output feed into module and module generation?
...
- candidate search module bundles
- eval tasks for internal and external search routing
- integration notes with skill-module and module-discovery-module
