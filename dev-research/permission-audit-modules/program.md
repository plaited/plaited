...
Research the default module bundle for durable approval, denial, revocation,
...
- [dev-research/three-axis-modules/program.md](../three-axis-modules/program.md) owns cross-cutting
  capability, autonomy, and authority policy
- [dev-research/node-auth-modules/program.md](../node-auth-modules/program.md) owns auth and trust boundary
  shaping
- [dev-research/observability-modules/program.md](../observability-modules/program.md) owns richer retained trace
  policy
...
- `three-axis-modules` owns the cross-cutting policy rules
- `node-auth-modules` owns auth identity and trust inputs
- adjacent capability lanes own the capability surfaces being gated

## Dependency Order

1. [skills/modnet-modules/SKILL.md](../../skills/modnet-modules/SKILL.md) defines current MSS and boundary framing
2. [dev-research/three-axis-modules/program.md](../three-axis-modules/program.md) defines autonomy and
...
The first shipped permission-audit module bundle should support:
...
- candidate permission-audit module bundles
