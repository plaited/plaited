...
- `01` community marketplaces and local networks
- `02` home, family, and personal life
- `03` work, business, and service operations
- `04` communication, publishing, and media
- `05` education, reference, and practice
- `06` creative tools and design
- `07` developer automation and system utilities
- `08` catalogs, archives, and collections
- `09` finance, health, and life planning
