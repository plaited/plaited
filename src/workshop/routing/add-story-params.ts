...
export const addStoryParams = ({filePath, storySet, storyParamSetSignal}:{filePath: string, storySet: StorySet, storyParamSetSignal: SignalWithInitialValue<Set<StoryParams>>}) => {
