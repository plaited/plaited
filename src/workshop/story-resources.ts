...
export const plaitedTestingResource = useResource({
  metaData: {
    ...
    description: 'Complete Plaited testing module with StoryObj types, Args utility, and Play function signature for writing component tests',
...
export const componentSourceResource = useResource({
  metaData: {
    ...
    description: 'TypeScript/JSX source of the component being tested, used to analyze props, p-target attributes, and behavior',
    mimeType: 'text/x-typescript',
  },
...
export const existingStoriesResource = useResource({
  metaData: {
    ...
    description: 'Reference story files showing established patterns, conventions, and testing approaches in the project',
    mimeType: 'text/x-typescript',
  },
