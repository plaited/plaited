...
export const interactionStory = story({
  intent: 'An interaction story with play function',
...
export const storyWithAllProps = story({
  intent: 'Story with all properties',
...
export const failingStory = story({
  intent: 'A story that intentionally fails',
