...
import { getDesignTokensElement, getDesignTokensSnapshot } from '../design-token-transformer.utils.js'

describe('getDesignTokensElement', () => {
  test('default', () => {
    expect(getDesignTokensElement(`:host{--blue: blue}`)).toMatchSnapshot()
  })

  test('custom tag name', () => {
    expect(getDesignTokensElement(`:host{--blue: blue}`, 'plaited-tokens')).toMatchSnapshot()
  })
})

describe('getDesignTokensSnapshot', () => {
