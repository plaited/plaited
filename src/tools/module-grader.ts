...
const matchDynamicIndicator = (code: string, item: string): boolean => {
  ...
  const patterns: Array<{ keywords: string[]; codeIndicators: string[] }> = [
    ...
    {
      keywords: ['toggle', 'switch', 'celsius', 'fahrenheit', 'unit', 'convert', 'conversion'],
      codeIndicators: [
        'toggle',
        'switch',
        'celsius',
    ...
    {
      keywords: ['calculates', 'calculate', 'compute', 'statistic', 'mean', 'median', 'deviation'],
      codeIndicators: [
        'mean',
        'median',
        'mode',
    ...
    {
      keywords: ['stroke', 'freehand', 'canvas', 'brush', 'paint', 'draw'],
      codeIndicators: [
        'mousemove',
        'mousedown',
        'mouseup',
    ...
    {
      keywords: ['marker', 'coordinate', 'latitude', 'longitude', 'geocod', 'tile', 'leaflet', 'circle'],
      codeIndicators: [
        'l.marker',
        '.marker(',
        'l.circle',
