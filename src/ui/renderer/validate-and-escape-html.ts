...
import { type HtmlError, HtmlValidationError } from './render.errors.ts'

export type { HtmlError } from './render.errors.ts'
export { HtmlValidationError } from './render.errors.ts'
/**
