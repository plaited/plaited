...
} from './search-factory.schemas.ts'
...
const toModuleResults = (query: string, modules: FactoryModuleCatalogEntry[]): SearchResultEntry[] =>
  modules
    .map((module) => ({
      id: `module:${module.id}`,
      label: module.id,
      description: `Factory module at ${module.path}`,
