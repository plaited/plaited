...
/**
 * Behavioral event keys used to drive the server module lifecycle.
 *
 * @public
 */
...
/**
 * Default signal keys written by the server module state graph.
 *
 * @public
 */
export const SERVER_MODULE_SIGNAL_KEYS = {
 ...
 * @public
 */
export const SERVER_MODULE_BASELINE_ROUTE_OWNER = 'baseline'
 ...
 * this header, or a stricter replacement, on routes that bypass the module's
