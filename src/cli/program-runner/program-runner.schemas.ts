...
export const ProgramRunnerAttemptSchema = z.object({
  ...
  repoOutOfScopePaths: z.array(z.string()).optional(),
  ...
  formatExitCode: z.number().int().optional(),
  typecheckExitCode: z.number().int().optional(),
  targetedTestsExitCode: z.number().int().optional(),
