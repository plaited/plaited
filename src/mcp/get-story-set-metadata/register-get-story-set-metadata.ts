...
import {
  GetStorySetMetaDataInputSchema,
  GetStorySetMetaDataOutputSchema,
  type StoryMetadata,
} from './get-story-set-metadata.schemas.js'
 ...
 * ```
 */
const getStorySetExportDetails = (filePath: string): StoryMetadata[] => {
...
export const registerGetStorySetMetadata = (server: McpServer) => {
  server.registerTool(
