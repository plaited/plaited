...
export const createFileSystemClient = defineMCPClient<FileSystemEvents>({
  ...
  publicEvents: ['SEARCH_FILES', 'CREATE_FILE', 'READ_RESOURCE', 'CALL_TOOL'],

  async bProgram({ client, tools, resources, prompts, trigger, bThread, bSync, disconnect: _disconnect }) {
