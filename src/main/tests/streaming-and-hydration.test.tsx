...
test('Fixture and Hydrating Element Interaction', async ({ page }) => {
  ...
  await fixtureHandle.evaluate((el, detail) => (el as TriggerableElement).trigger('onReplaceChildren', detail), replaceChildrenHtml);
  ...
  await fixtureHandle.evaluate((el, detail) => (el as TriggerableElement).trigger('onReplaceChildren', detail), hydratingElementHTML);
