...
## Plaited-Specific Type Documentation Requirements

All TypeScript type patterns (complex objects, unions, functions, mapped types, recursive types, etc.) should follow standard TSDoc format with these Plaited-specific conventions:
