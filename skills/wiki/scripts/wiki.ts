...
import { extractLocalLinksFromMarkdown, makeCli } from 'plaited/cli'
...
const TYPESCRIPT_LSP_COMMAND = 'run skills/typescript-lsp/scripts/typescript-lsp.ts'
...
if (import.meta.main) {
  await wikiCli(Bun.argv.slice(2))
}
