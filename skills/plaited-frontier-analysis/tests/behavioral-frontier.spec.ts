...
const runBehavioralFrontierScript = async (args: string[]) =>
  Bun.$`bun run skills/plaited-frontier-analysis/scripts/behavioral-frontier.ts ${args}`
    .cwd(CLI_PACKAGE_ROOT)
    .quiet()
    .nothrow()

const runBehavioralFrontierCommand = async (input: unknown) =>
  Bun.$`bun run skills/plaited-frontier-analysis/scripts/behavioral-frontier.ts ${JSON.stringify(input)}`
    .cwd(CLI_PACKAGE_ROOT)
    .quiet()
    .nothrow()
...
describe('behavioral-frontier CLI', () => {
  ...
  test('behavioral-frontier script schema input emits inline and specPath branches', async () => {
    const result = await runBehavioralFrontierScript(['--schema', 'input'])
  ...
  test('behavioral-frontier script schema output emits replay explore and verify shapes', async () => {
    const result = await runBehavioralFrontierScript(['--schema', 'output'])
