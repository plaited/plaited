/**
 * Search the Varlock documentation via MCP.
 *
 * Usage: bun run search.ts '{"query": ".env.schema format"}'
 */

import { mcpCallTool } from '../../add-remote-mcp/scripts/remote-mcp.ts'

const MCP_URL = 'https://docs.mcp.varlock.dev/mcp'
const TOOL_NAME = 'varlock docs'
