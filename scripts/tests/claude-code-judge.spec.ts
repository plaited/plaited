...
import { GraderResultSchema, RepoImprovementJudgeOutcomeSchema } from '../../src/improve.ts'
...
describe('claude-code-judge', () => {
  test('returns a schema-valid grader result', () => {
    ...
    expect(
      RepoImprovementJudgeOutcomeSchema.parse({
    ...
    expect(result.outcome?.judgeDimensions).toEqual({
      architecture: 0.95,
      boundedness: 0.9,
      focus: 0.92,
      quality: 0.85,
