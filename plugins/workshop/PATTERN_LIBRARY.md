...
This document describes how to extract, document, and maintain patterns for the `plaited-patterns` skill in the workshop plugin.

## Overview

The `plaited-patterns` skill (`plugins/workshop/skills/plaited-patterns/`) is a comprehensive knowledge base of Plaited framework patterns. It enables AI-assisted development by providing:
...
```
plugins/workshop/skills/plaited-patterns/
