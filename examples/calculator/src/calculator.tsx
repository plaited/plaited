...
export const CalculatorTemplate: PlaitedElement = () => (<Calculator.template><div class={classes.calculator}
  {...stylesheet}
>
  {/* <!-- display --> */}
  ...
  <button class={classes.side}
    data-trigger={{ click: 'divide' }}
    value='divide'
  >{symbols.divide}</button>
  {/* <!-- Row two --> */}
  <button class={classes.number}
