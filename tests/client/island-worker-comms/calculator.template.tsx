...
import { classes, stylesheet } from './calculator.styles.ts'
import { CalculatorIsland } from './calculator.island.ts'

export const CalculatorTemplate = () => (
  <CalculatorIsland.template {...stylesheet} data-target='calculator'>
    <div class={classes.calculator}>
      ...
      {/* <!-- Row five --> */}
      <button class={classes.clear} data-trigger={{ click: 'clear' }}>
        AC
      </button>
      <button
        class={classes.number}
      ...
      <button class={classes.number} data-trigger={{ click: 'period' }}>
        .
      </button>
      <button
        class={classes.side}
