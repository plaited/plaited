...
export declare const useBehavioral: ({ id, connect, dev, strategy, context, }: {
    ...
    connect?: ((recipient: string, trigger: Trigger) => () => void) | undefined;
    ...
    addThreads: (threads: Record<string, import("@plaited/behavioral").RulesFunc>) => void;
    feedback: import("@plaited/behavioral").Feedback;
    loop: (rules: import("@plaited/behavioral").RulesFunc<any>[], condition?: (() => boolean) | undefined) => import("@plaited/behavioral").RulesFunc<any>;
    sync: <T extends unknown>(set: import("@plaited/behavioral").RuleSet<T>) => import("@plaited/behavioral").RulesFunc<T>;
    thread: (...rules: import("@plaited/behavioral").RulesFunc<any>[]) => import("@plaited/behavioral").RulesFunc<any>;
    trigger: Trigger;
