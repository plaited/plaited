  ...
  factory: function (require) {
    var plugin = (() => {
      ...
      var Be = (
        ...
        wr = (e) => Je(we({}, "__esModule", { value: !0 }), e);
      var ve = q((ee) => {
        "use strict";
        ee.isInteger = (e) =>
          typeof e == "number"
      ...
      var Ue = q((es, Et) => {
        ...
        var Or = W("util"),
          ...
          Me = (e) => typeof e == "number" || typeof e == "string" && e !== "",
          ...
          yt = (...e) =>
            new RangeError("Invalid range arguments: " + Or.inspect(...e)),
          _t = (e, r, t) => {
          ...
          Dr = (e, r, t = 1, n = {}) => {
            ...
            for (
              ...
              n.toRegex === !0 && t > 1 ? y(s) : E.push(Br($(s, S), R, f)),
                s = a ? s - t : s + t,
                S++;
            }
            return n.toRegex === !0
          ...
          $e = (e, r, t, n = {}) => {
            ...
            return s.capture === !0 && (s.wrap = !0),
              ...
              Ae(t)
                ? Ae(e) && Ae(r)
                  ? Dr(e, r, t, s)
                  : Ur(e, r, Math.max(Math.abs(t), 1), s)
                : t != null && !dt(t)
                ? Mr(t, s)
                : $e(e, r, 1, t);
          };
          ...
          Wr = (e, r = {}) => {
            let t = r.rangeLimit === void 0 ? 1e3 : r.rangeLimit,
              n = (s, i = {}) => {
                ...
                for (
                  ;
                  h.type !== "brace" && h.type !== "root" && h.parent;
...
`,
      ...
      var Nt = q((ss, Ot) => {
        ...
        var jr = He(),
          ...
          nn = (e, r = {}) => {
            ...
            for (y({ type: "bos" }); h < m;) {
              if (a = i[i.length - 1], f = _(), !(f === rn || f === tn)) {
                if (f === Ge) {
      ...
      var Pt = q((as, Bt) => {
        ...
        Z.parse = (e, r = {}) => on(e, r);
        Z.stringify = (e, r = {}) =>
          It(typeof e == "string" ? Z.parse(e, r) : e, r);
        Z.compile = (
          e,
          r = {},
        ) => (typeof e == "string" && (e = Z.parse(e, r)), sn(e, r));
        Z.expand = (e, r = {}) => {
        ...
        var ke = me(),
          ...
          Vt = (e, r) => {
            ...
            if (t.fastpaths !== !1 && !/(^[*!]|[/()[\]{}"])/.test(e)) {
              ...
              return A === !0 &&
                (t.unescape === !0 ? O = O.replace(/\\/g, "") : O = O.replace(
                  /\\+/g,
                  (d) => d.length % 2 === 0 ? "\\\\" : d ? "\\" : "",
                )),
                O === e && t.contains === !0
                  ? (l.output = e, l)
                  : (l.output = Y.wrapOutput(O, l, r), l);
            }
            for (; !P();) {
              if (u = V(), u === "\0") continue;
              if (u === "\\") {
                ...
                if (
                  x && x[0].length > 2 &&
                  (M = x[0].length, l.index += M, M % 2 !== 0 && (u += "\\")),
              ...
              if (u === "[") {
                if (t.nobracket === !0 || !J().includes("]")) {
                  if (
                    t.nobracket !== !0 && t.strictBrackets === !0
              ...
              if (u === "]") {
                ...
                if (
                  ...
                  (u = `/${u}`),
                    o.value += u,
                    Ee({ value: u }),
                    t.literalBrackets === !1 || Y.hasRegexChars(d)
                ) continue;
              ...
              if (u === "}") {
                ...
                if (d.dots === !0) {
                  ...
                  for (
                    let G = M.length - 1;
                    G >= 0 && (a.pop(), M[G].type !== "brace");
                    G--
                  ) M[G].type !== "dots" && j.unshift(M[G].value);
      ...
      var rr = q((ls, tr) => {
        ...
        var Pn = W("path"),
          ...
          Ye = Re(),
          Dn = me(),
          Un = (e) => e && typeof e == "object" && !Array.isArray(e),
          D = (e, r, t = !1) => {
            if (Array.isArray(e)) {
      ...
      var cr = q((ps, ur) => {
        ...
        N.contains = (e, r, t) => {
          if (typeof e != "string") {
            throw new TypeError(
              `Expected a string: "${ir.inspect(e)}"`,
            );
          }
          ...
          if (typeof r == "string") {
            ...
            if (
              e.includes(r) || e.startsWith("./") && e.slice(2).includes(r)
            ) return !0;
          }
        ...
        ce = class extends Se.BaseCommand {
          ...
          async execute() {
            ...
            if (this.all) a = new Set(n.workspaces);
              ...
              if (!s) {
                throw new Se.WorkspaceRequiredError(
                  n.cwd,
                  this.context.cwd,
                );
              }
      ...
      var Ne = W("@yarnpkg/cli"),
        ...
        pe = class extends Ne.BaseCommand {
          ...
          async execute() {
            ...
            if (!this.all && !s) {
              throw new Ne.WorkspaceRequiredError(
                n.cwd,
                this.context.cwd,
              );
            }
            ...
            let c = this.all ? n.topLevelWorkspace : s,
              ...
              m = (g) =>
                Oe.default.isMatch(
                  F.structUtils.stringifyIdent(g.locator),
                  this.from,
                ),
            ...
            let _ = this.parallel
                ? this.jobs === "unlimited" ? 1 / 0 : Number(this.jobs) ||
                  Math.ceil(F.nodeUtils.availableParallelism() / 2)
                : 1,
                  ...
                  try {
                    ...
                    if (this.verbose) {
                      let J = t.get("enableTimers")
                        ? `, completed in ${
                          F.formatUtils.pretty(
                            t,
                            V - P,
                            F.formatUtils.Type.DURATION,
                          )
                        }`
                        : "";
                      g.reportInfo(
                ...
                for (; T.size > 0 && !g.hasErrors();) {
                  ...
                  if (k.length === 0) {
                    let w = Array.from(T.values()).map((B) =>
                      F.structUtils.prettyLocator(t, B.anchoredLocator)
                    ).join(", ");
                    g.reportError(
