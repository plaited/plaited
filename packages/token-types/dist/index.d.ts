 ...
 */
export type DimensionValue = number | ScalarDimensionValue | AliasValue;
/**
...
export type GradientValue = {
    gradientFunction: 'linear-gradient' | 'radial-gradient' | 'conic-gradient' | 'repeating-linear-gradient' | 'repeating-radial-gradient' | 'repeating-conic-gradient';
 ...
 */
export type DistributeContentValue = 'start' | 'end' | 'center' | 'space-between' | 'space-around' | 'stretch' | 'space-evenly' | AliasValue;
/**
...
type GridTemplateAxisValue = GridMinMaxArgs | {
    function: 'minmax';
...
export type GridValue = {
    display: AliasValue;
    gridTemplateColumns?: AliasValue;
    gridTemplateRows?: AliasValue;
    gridTemplateAreas?: AliasValue;
    columnGap?: AliasValue;
    rowGap?: AliasValue;
    ...
    justifyContent?: AliasValue;
    alignContent?: AliasValue;
    gridAutoColumns?: AliasValue;
    gridAutoRows?: AliasValue;
 ...
 */
export type FontWeightValue = 100 | 200 | 300 | 400 | 500 | 600 | 700 | 800 | 900 | 'normal' | 'bold' | 'lighter' | 'bolder' | AliasValue;
/**
 * FontFamily value type relies on the dimension formatter for css tokens
 * and the defaultFormat formatter for ts tokens
 */
 ...
 * FontWeight value type relies on the fontFamily the defaultFormat formatter for ts tokens and css tokens
 */
export type TextTransformValue = 'none' | 'capitalize' | 'uppercase' | 'lowercase' | 'full-width' | 'full-size-kana' | AliasValue;
/**
...
export type $FormatterValue = PrimitiveValue | PrimitiveArrayValue | BorderValue | DimensionValue | GradientValue | DropShadowValue | GapValue | FlexValue | GridTemplateValue | GridValue | TransitionValue | FontFamilyValue | TypographyValue;
type ValueAndType = {
    $type: 'primitive';
